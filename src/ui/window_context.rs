...
impl WindowContext {
    pub fn new(
        ...
        let winit_window_builder = winit::window::WindowAttributes::default()
            ...
            .with_title("wlrip")
            // wayland app_id — lets compositors (niri/Hyprland) target the
            // window in their window rules. the `general` field is used as the
            // wl_surface app_id.
            .with_name("wlrip", "wlrip");
